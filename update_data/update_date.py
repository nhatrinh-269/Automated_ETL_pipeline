...
log(f'Start updating satellite images from day {start_date}-{start_month}-{year} to day {end_date}-{end_month}-{year}', logfile)
...
log('Finish updating satellite images', logfile) 